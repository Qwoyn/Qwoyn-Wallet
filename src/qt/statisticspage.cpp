...
void StatisticsPage::updateStatistics()
{
	...
	int64_t marketcap = qwnmarket.toDouble();
    ...
    {
        subsidy = "3 QWN per block";
    }
	else if (pindexBest->nHeight < 2000000)
    {
        subsidy = "4 QWN per block";
    }
	else if (pindexBest->nHeight < 3000000)
    {
        subsidy = "3 QWN per block";
    ...
    {
        ui->volumeBox->setText("<b><font color=\"yellow\">" + qVolume + " QWN" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " QWN" + "</font></b>");
    } else {
        ui->volumeBox->setText("<b><font color=\"orange\">" + qVolume + " QWN" + "</font></b>");
    }
